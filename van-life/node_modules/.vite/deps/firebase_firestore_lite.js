...
(function() {
  ...
  m2.prototype.u = function(f2, a) {
    ...
    for (var c = a - this.blockSize, d = this.B, e = this.h, g2 = 0; g2 < a; ) {
      if (0 == e) for (; g2 <= c; ) n(this, f2, g2), g2 += this.blockSize;
      if ("string" === typeof f2) for (; g2 < a; ) {
      ...
      else for (; g2 < a; ) if (d[e++] = f2[g2++], e == this.blockSize) {
        n(this, d);
        e = 0;
        break;
      }
  ...
  function y2(f2, a) {
    ...
    for (var c = v2(Math.pow(a, 8)), d = w2, e = 0; e < f2.length; e += 8) {
      var g2 = Math.min(8, f2.length - e), b2 = parseInt(f2.substring(e, e + g2), a);
  ...
  h.toString = function(f2) {
    ...
    for (var a = v2(Math.pow(f2, 6)), c = this, d = ""; ; ) {
      var e = D2(c, a).g;
      c = F2(c, e.j(a));
      var g2 = ((0 < c.g.length ? c.g[0] : c.h) >>> 0).toString(f2);
      c = e;
      if (C2(c)) return g2 + d;
  ...
  h.add = function(f2) {
    for (var a = Math.max(this.g.length, f2.g.length), c = [], d = 0, e = 0; e <= a; e++) {
      var g2 = d + (this.i(e) & 65535) + (f2.i(e) & 65535), b2 = (g2 >>> 16) + (this.i(e) >>> 16) + (f2.i(e) >>> 16);
      d = b2 >>> 16;
      g2 &= 65535;
      b2 &= 65535;
      c[e] = b2 << 16 | g2;
  ...
  h.j = function(f2) {
    ...
    for (d = 0; d < this.g.length; d++) for (var e = 0; e < f2.g.length; e++) {
      var g2 = this.i(d) >>> 16, b2 = this.i(d) & 65535, r = f2.i(e) >>> 16, E2 = f2.i(e) & 65535;
      c[2 * d + 2 * e] += b2 * E2;
      G(c, 2 * d + 2 * e);
      c[2 * d + 2 * e + 1] += g2 * E2;
      G(c, 2 * d + 2 * e + 1);
  ...
  function D2(f2, a) {
    ...
    if (C2(f2)) return new H(w2, w2);
    if (B2(f2)) return a = D2(x2(f2), a), new H(x2(a.g), x2(a.h));
    if (B2(a)) return a = D2(f2, x2(a)), new H(x2(a.g), a.h);
    if (30 < f2.g.length) {
      if (B2(f2) || B2(a)) throw Error("slowDivide_ only works with positive integers.");
      for (var c = z2, d = a; 0 >= d.l(f2); ) c = I2(c), d = I2(d);
      var e = J(c, 1), g2 = J(d, 1);
      d = J(d, 2);
      for (c = J(c, 2); !C2(d); ) {
        var b2 = g2.add(d);
        0 >= b2.l(f2) && (e = e.add(c), g2 = b2);
        d = J(d, 1);
        c = J(c, 1);
      }
      a = F2(f2, e.j(a));
    ...
    for (e = w2; 0 <= f2.l(a); ) {
      ...
      g2 = v2(c);
      for (b2 = g2.j(a); B2(b2) || 0 < b2.l(f2); ) c -= d, g2 = v2(c), b2 = g2.j(a);
      C2(g2) && (g2 = z2);
      e = e.add(g2);
      f2 = F2(f2, b2);
    }
  ...
  function J(f2, a) {
    var c = a >> 5;
    a %= 32;
    for (var d = f2.g.length - c, e = [], g2 = 0; g2 < d; g2++) e[g2] = 0 < a ? f2.i(g2 + c) >>> a | f2.i(g2 + c + 1) << 32 - a : f2.i(g2 + c);
    return new t(e, f2.h);
  }
...
var f = "11.2.0";
var E = new Logger("@firebase/firestore");
...
var p = "permission-denied";
var y = "unauthenticated";
var w = "resource-exhausted";
var g = "failed-precondition";
var F = "aborted";
var v = "out-of-range";
var D = "unimplemented";
var b = "internal";
  ...
  static fromServerFormat(t) {
    ...
    for (; n < t.length; ) {
      ...
      if ("\\" === e2) {
        ...
        const e3 = t[n + 1];
        if ("\\" !== e3 && "." !== e3 && "`" !== e3) throw new FirestoreError(P, "Path has invalid escape sequence: " + t);
        r += e3, n += 2;
...
function __PRIVATE_mapCodeFromHttpStatus(t) {
  if (void 0 === t) return __PRIVATE_logError("RPC_ERROR", "HTTP error has no status"), T;
  switch (t) {
    case 200:
      return m;
    case 400:
...
($ = B || (B = {}))[$.OK = 0] = "OK", $[$.CANCELLED = 1] = "CANCELLED", $[$.UNKNOWN = 2] = "UNKNOWN", $[$.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", $[$.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", $[$.NOT_FOUND = 5] = "NOT_FOUND", $[$.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", $[$.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", $[$.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", $[$.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", $[$.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", $[$.ABORTED = 10] = "ABORTED", $[$.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", $[$.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", $[$.INTERNAL = 13] = "INTERNAL", $[$.UNAVAILABLE = 14] = "UNAVAILABLE", $[$.DATA_LOSS = 15] = "DATA_LOSS";
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  R(t, e, r, n) {
    return this.Y(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.R(t, __PRIVATE_toResourcePath(e, r), n, i, s)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === y && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new FirestoreError(T, t2.toString());
    });
  }
...
var FirestoreSettingsImpl = class {
  constructor(t) {
    ...
    !function __PRIVATE_validateIsNotUsedTogether(t2, e2, r2, n) {
      if (true === e2 && true === n) throw new FirestoreError(P, `${t2} and ${r2} cannot be used together.`);
      ...
      if (void 0 !== t2.timeoutSeconds) {
        if (isNaN(t2.timeoutSeconds)) throw new FirestoreError(P, `invalid long polling timeout: ${t2.timeoutSeconds} (must not be NaN)`);
        if (t2.timeoutSeconds < 5) throw new FirestoreError(P, `invalid long polling timeout: ${t2.timeoutSeconds} (minimum allowed value is 5)`);
        if (t2.timeoutSeconds > 30) throw new FirestoreError(P, `invalid long polling timeout: ${t2.timeoutSeconds} (maximum allowed value is 30)`);
      }
...
var Firestore = class {
  ...
  _terminate() {
    return function __PRIVATE_removeComponents(t) {
      const e = U.get(t);
      e && (__PRIVATE_logDebug("ComponentProvider", "Removing Datastore"), U.delete(t), e.terminate());
...
function connectFirestoreEmulator(t, e, r, n = {}) {
  ...
  if ("firestore.googleapis.com" !== s.host && s.host !== o && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."), t._setSettings(Object.assign(Object.assign({}, s), {
    ...
    if ("string" == typeof n.mockUserToken) e2 = n.mockUserToken, r2 = User.MOCK_USER;
      ...
      if (!s2) throw new FirestoreError(P, "mockUserToken must contain 'sub' or 'user_id' field!");
      r2 = new User(s2);
    }
...
function collectionGroup(t, e) {
  if (t = __PRIVATE_cast(t, Firestore), __PRIVATE_validateNonEmptyArgument("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new FirestoreError(P, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
  return new Query(
    t,
    /* converter= */
    null,
...
var Bytes = class _Bytes {
  ...
  static fromBase64String(t) {
    try {
      ...
      throw new FirestoreError(P, "Failed to construct data from Base64 string: " + t2);
    }
  }
  /**
...
function __PRIVATE_parseSetData(t, e, r, n, i, s = {}) {
  ...
  if (s.merge) u = new FieldMask(o.fieldMask), _ = o.fieldTransforms;
    ...
    for (const n2 of s.mergeFields) {
      ...
      if (!o.contains(i2)) throw new FirestoreError(P, `Field '${i2}' is specified in your field mask but missing from your input data.`);
...
function __PRIVATE_fieldPathFromDotSeparatedString(t, e, r) {
  if (e.search(z) >= 0) throw __PRIVATE_createError(
...
function __PRIVATE_createError(t, e, r, n, i) {
  ...
  let u = "";
  return (s || o) && (u += " (found", s && (u += ` in field ${n}`), o && (u += ` in document ${i}`), u += ")"), new FirestoreError(P, a + t + u);
}
...
function query(t, e, ...r) {
  ...
  e instanceof AppliableConstraint && n.push(e), n = n.concat(r), function __PRIVATE_validateQueryConstraintArray(t2) {
    ...
    if (e2 > 1 || e2 > 0 && r2 > 0) throw new FirestoreError(P, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
  }(n);
...
var QueryFieldFilterConstraint = class _QueryFieldFilterConstraint extends QueryConstraint {
  ...
  _parse(t) {
    const e = __PRIVATE_newUserDataReader(t.firestore), r = function __PRIVATE_newQueryFilter(t2, e2, r2, n, i, s, o) {
      let a;
      if (i.isKeyField()) {
        if ("array-contains" === s || "array-contains-any" === s) throw new FirestoreError(P, `Invalid Query. You can't perform '${s}' queries on documentId().`);
        if ("in" === s || "not-in" === s) {
...
var QueryOrderByConstraint = class _QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(t) {
    const e = function __PRIVATE_newQueryOrderBy(t2, e2, r) {
      if (null !== t2.startAt) throw new FirestoreError(P, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
      if (null !== t2.endAt) throw new FirestoreError(P, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
...
function __PRIVATE_newQueryBoundFromDocOrFields(t, e, r, n) {
  if (r[0] = getModularInstance(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(t2, e2, r2, n2, i) {
    if (!n2) throw new FirestoreError(I, `Can't use a DocumentSnapshot that doesn't exist for ${r2}().`);
    const s = [];
    for (const r3 of __PRIVATE_queryNormalizedOrderBy(t2)) if (r3.field.isKeyField()) s.push(__PRIVATE_refValue(e2, n2.key));
      ...
      if (__PRIVATE_isServerTimestamp(t3)) throw new FirestoreError(P, 'Invalid query. You are trying to start or end a query using a document for which the field "' + r3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
      if (null === t3) {
        const t4 = r3.field.canonicalString();
        throw new FirestoreError(P, `Invalid query. You are trying to start or end a query using a document for which the field '${t4}' (used as the orderBy) does not exist.`);
      }
      s.push(t3);
    }
  ...
  }(t._query, t.firestore._databaseId, e, r[0]._document, n);
  {
    ...
    return function __PRIVATE_newQueryBoundFromFields(t2, e2, r2, n2, i2, s) {
      ...
      if (i2.length > o.length) throw new FirestoreError(P, `Too many arguments provided to ${n2}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
      const a = [];
      for (let s2 = 0; s2 < i2.length; s2++) {
        const u = i2[s2];
        if (o[s2].field.isKeyField()) {
          if ("string" != typeof u) throw new FirestoreError(P, `Invalid query. Expected a string for document ID in ${n2}(), but got a ${typeof u}`);
          if (!__PRIVATE_isCollectionGroupQuery(t2) && -1 !== u.indexOf("/")) throw new FirestoreError(P, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${n2}() must be a plain document ID, but '${u}' contains a slash.`);
          const r3 = t2.path.child(ResourcePath.fromString(u));
          if (!DocumentKey.isDocumentKey(r3)) throw new FirestoreError(P, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${n2}() must result in a valid document path, but '${r3}' is not because it contains an odd number of segments.`);
...
function getDocs(t) {
  (function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t2) {
    if ("L" === t2.limitType && 0 === t2.explicitOrderBy.length) throw new FirestoreError(D, "limitToLast() queries require specifying at least one orderBy() clause");
...
var Transaction$1 = class {
  ...
  async lookup(t) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw this.lastTransactionError = new FirestoreError(P, "Firestore transactions require all reads to be executed before all writes."), this.lastTransactionError;
...
var __PRIVATE_TransactionRunner = class {
  ...
  Rt(t) {
    this.ft > 0 && this.It(t) ? (this.ft -= 1, this.asyncQueue.enqueueAndForget(() => (this.Tt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  It(t) {
...
function runTransaction(t, e, r) {
  ...
  !function __PRIVATE_validateTransactionOptions(t2) {
    if (t2.maxAttempts < 1) throw new FirestoreError(P, "Max attempts must be at least 1");
  }(i);
...
!function __PRIVATE_registerFirestore() {
  !function __PRIVATE_setSDKVersion(t) {
    ...
    const n = t.getProvider("app").getImmediate(), i = new Firestore(new __PRIVATE_LiteAuthCredentialsProvider(t.getProvider("auth-internal")), new __PRIVATE_LiteAppCheckTokenProvider(t.getProvider("app-check-internal")), function __PRIVATE_databaseIdFromApp(t2, e2) {
      if (!Object.prototype.hasOwnProperty.apply(t2.options, ["projectId"])) throw new FirestoreError(P, '"projectId" not provided in firebase.initializeApp.');
